...
public class CustemWebView extends WebView {
    ...
    public CustemWebView(Context arg0) {
        this(arg0, null);
    }

    public CustemWebView(Context arg0, AttributeSet arg1) {
        this(arg0, arg1, 0);
    }

    public CustemWebView(Context arg0, AttributeSet arg1, int arg2) {
    ...
    /**
     * 其他webview的touch事件必须滚动后才能响应
     * 并出现错误：Should not happen: no rect-based-test nodes found，解决办法是在touch down的时候让webview滚动一下
     *
     * @param event
     * @return
     */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            scrollTo(getScrollX(), temp_ScrollY); //返回原来位置，可不加
        }
