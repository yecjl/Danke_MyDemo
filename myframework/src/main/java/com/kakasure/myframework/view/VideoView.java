...
public class VideoView extends SurfaceView implements MediaPlayerControl {
    ...
    /**
     * add by danke, 新的api必须实现getAudioSession
     */
    ...
    public OnPlayPauseListener getOnPlayPauseListener() {
        return mOnPlayPauseListener;
    }

    public void setOnPlayPauseListener(OnPlayPauseListener mOnPlayPauseListener) {
        this.mOnPlayPauseListener = mOnPlayPauseListener;
    }
